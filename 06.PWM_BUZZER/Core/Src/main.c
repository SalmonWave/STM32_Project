...
int main(void)
{
  ...
  HAL_UART_Receive_IT(&huart2, &rx_data, 1);	//	Initialize UART DATA to RX_DATA
  HAL_TIM_IC_Start_IT(&htim1, TIM_CHANNEL_1);	//	COUNTING PULSE (RISING EDGE TO FALLING EDGE)
