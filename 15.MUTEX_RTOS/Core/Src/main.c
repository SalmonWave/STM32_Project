...
volatile int TIM11_LCD_TIMER = 0;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5|CE_DS1302_Pin|IO_DS1302_Pin|CLK_DS1302_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA5 CE_DS1302_Pin IO_DS1302_Pin CLK_DS1302_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_5|CE_DS1302_Pin|IO_DS1302_Pin|CLK_DS1302_Pin;
